...
tags: [ "Documentation", "Software Engineering", "Testing", "JavaScript + TypeScript", "Portfolio"]
...
{% info %}This is the first spike for the [Testable Documentation project](/testable-documentation-intro/).{% endinfo %}
