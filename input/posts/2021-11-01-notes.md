...
{% h2br %}Update 2026-01-18{% endh2br %}

I have been planning an update video for ... a couple of years at this point but wanted to add a few recent details:

- I use my open-sourced tool [mdsync](https://github.com/joshcanhelp/mdsync) to manage blog posts in [Obsidian](https://www.joshcanhelp.com/tag/obsidian/) and then sync the final product to my repo for publishing.
- I still use daily notes constantly, it's usually the best place to put things that don't really have a home.
- I used [Dataview](https://blacksmithgu.github.io/obsidian-dataview/) for a while, but am in the process of converting that to core [Bases](https://help.obsidian.md/bases). I'd like to find a way to embed bases in the editor without adding them to the note content.
